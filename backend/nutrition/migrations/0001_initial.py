    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='nutrition_profile', to='diet_plans.food')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nutrition_tracking', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nutrient', models.CharField(choices=[('vitamin_c', 'Vitamin C'), ('vitamin_d', 'Vitamin D'), ('calcium', 'Calcium'), ('iron', 'Iron'), ('magnesium', 'Magnesium'), ('potassium', 'Potassium'), ('zinc', 'Zinc'), ('folate', 'Folate'), ('vitamin_b12', 'Vitamin B12')], max_length=20)),
                ('daily_target', models.FloatField()),
                ('unit', models.CharField(default='mg', max_length=10)),
                ('nutrition_goal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='micronutrient_targets', to='nutrition.nutritiongoal')),
            ],
            options={
